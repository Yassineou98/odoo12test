...
class SupportTeam(models.Model):
    ...
    members_ids = fields.One2many('helpdesk_lite.employee', 'team_ids', string='Team Members')
    ...
    active = fields.Boolean(default=True,
                            help="If the active field is set to false, it will allow you to hide the support team without removing it.")
